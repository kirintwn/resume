...
%---------------------------------------------------------
\cventry
{Senior Software Engineer \acvHeaderSocialSep {\fontsize{8pt}{1em}\bodyfont\upshape\color{graytext} TypeScript · PostgreSQL · Redis · Terraform · Kubernetes · AWS}} % Job title
{Xendit} % Organization
